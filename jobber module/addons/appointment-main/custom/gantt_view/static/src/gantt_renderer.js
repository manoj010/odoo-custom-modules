...
export class GanttRenderer extends Component {
    ...
    static connectorCreatorTemplate = "gantt_view.GanttRenderer.ConnectorCreator";
    static headerTemplate = "gantt_view.GanttRenderer.Header";
    static pillTemplate = "gantt_view.GanttRenderer.Pill";
    static groupPillTemplate = "gantt_view.GanttRenderer.GroupPill";
    static rowContentTemplate = "gantt_view.GanttRenderer.RowContent";
    static rowHeaderTemplate = "gantt_view.GanttRenderer.RowHeader";
    static totalRowTemplate = "gantt_view.GanttRenderer.TotalRow";
