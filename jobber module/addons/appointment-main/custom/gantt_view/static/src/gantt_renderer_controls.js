...
export class GanttRendererControls extends Component {
    static template = "gantt_view.GanttRendererControls";
    static components = {
        Dropdown,
        DropdownItem,
    };
    static props = ["model", "displayExpandCollapseButtons", "focusToday", "getCurrentFocusDate"];
    static toolbarContentTemplate = "gantt_view.GanttRendererControls.ToolbarContent";
    static rangeMenuTemplate = "gantt_view.GanttRendererControls.RangeMenu";
