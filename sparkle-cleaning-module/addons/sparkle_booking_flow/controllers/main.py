...
class SparkleBookingController(http.Controller):
    ...
    def services(self):
        services = request.env["sparkle.booking.service"].sudo().search(
    ...
    def availability(self, **payload):
        ...
        service = request.env["sparkle.booking.service"].sudo().browse(service_id)
    ...
    def create_booking(self, **payload):
        ...
        booking = request.env["sparkle.booking"].sudo().create(
            {
    ...
    def _get_available_slots(self, service, booking_date):
        Availability = request.env["sparkle.booking.availability"].sudo()
