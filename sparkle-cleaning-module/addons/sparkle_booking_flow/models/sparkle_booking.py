...
class SparkleBookingAvailability(models.Model):
    _name = "sparkle.booking.availability"
    _description = "Sparkle Booking Availability"
    _order = "service_id, weekday, start_time"

    service_id = fields.Many2one("sparkle.booking.service", required=True, ondelete="cascade")
...
class SparkleBooking(models.Model):
    ...
    service_id = fields.Many2one("sparkle.booking.service", required=True)
